...
--
-- Host: 127.0.0.1
-- Generation Time: Nov 14, 2024 at 07:31 PM
...
(2, 'Fahri Pratama', 'fahri', '123', 'Admin'),
(3, 'Hilmi Aziz', 'hilmi', '123', 'Owner'),
(123, 'mohamad arkan', 'arkan', '123', 'Owner');
...
(1, 'vit', 25, 'ud.uye', 'Minuman', 1500, 3000),
(12345, 'supermie', 50, 'agus sentosa', 'Makanan', 3000, 4000);
...
--
ALTER TABLE `akun`
  MODIFY `id_akun` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=12346;
